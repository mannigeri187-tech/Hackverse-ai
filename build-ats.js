...
const code = \import { Mail, Phone, MapPin, Globe, Github, Linkedin } from 'lucide-react';
            ...
            {visibleProjects.map(proj => (
              <div key={proj.id}>
                <div className="flex justify-between items-baseline font-bold text-sm">
                  ...
                  {proj.githubUrl && <a href={proj.githubUrl} className="font-normal underline">GitHub</a>}
                </div>
            ...
            {data.education.map(edu => (
              <div key={edu.id}>
                ...
                <div className="flex justify-between items-baseline text-sm">
                  <span>{edu.degree} {edu.field && \\\in \\\\\\}</span>
...
fs.writeFileSync('src/components/resume/themes/ATSProTheme.tsx', code, 'utf8');
