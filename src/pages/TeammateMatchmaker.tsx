...
import { Heart, X, Sparkles, UserCheck, MessageSquare, Play, Video, Plus, Clock, Tag, Award, CheckCircle, Flame, Filter, ShieldCheck } from 'lucide-react';
...
export default function TeammateMatchmaker() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-8 font-sans">
      {/* Header */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-gray-200 dark:border-white/10 p-6 rounded-3xl shadow-xl">
        <div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="relative h-80 w-full overflow-hidden bg-slate-900">
                  ...
                  <div className="absolute top-4 right-4 bg-emerald-500/90 text-white px-3 py-1.5 rounded-full font-extrabold text-xs flex items-center gap-1.5 shadow-lg backdrop-blur-md">
                    <Sparkles className="w-3.5 h-3.5 fill-white" /> {currentProfile.compatibility}% Match
                  </div>
