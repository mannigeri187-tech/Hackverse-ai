  ...
  if (!profile) {
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="bg-white border border-slate-200 p-8 rounded-3xl text-center max-w-md w-full">
          <h2 className="text-2xl font-bold text-slate-900 mb-2">Profile Not Found</h2>
          <p className="text-slate-500 mb-6">The hacker you are looking for does not exist or has set their profile to private.</p>
          <Link to="/" className="inline-block px-6 py-2.5 bg-indigo-600 text-slate-900 font-bold rounded-xl hover:bg-indigo-500 transition-colors">
            Return Home
          </Link>
        </div>
      </div>
        ...
        <div className="relative bg-white  border border-slate-200 rounded-[2rem] shadow-2xl shadow-slate-200/50 overflow-hidden">
          ...
          <div className="relative p-8 sm:p-12">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              {/* Avatar */}
              <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full flex items-center justify-center text-4xl font-black shrink-0 overflow-hidden border-4 border-slate-200 shadow-lg bg-gradient-to-br from-primary-50 to-white text-primary-700">
                {profile.avatar_url ? (
