import { calculateJobMatch } from './src/utils/resume/jobMatchEngine';

const TEST_A_JD = "Frontend Developer. React, TypeScript, JavaScript, HTML, CSS.";
const TEST_A_RESUME = { summary: 'Frontend Developer', skills: ['React', 'TypeScript', 'JavaScript', 'HTML', 'CSS'], projects: [{name: 'Web', description: 'React', included: true}] } as any;
...
const TEST_B_RESUME = { summary: 'Cloud Engineer', skills: ['React', 'TypeScript', 'Figma'], projects: [{name: 'Web', description: 'Frontend', included: true}] } as any;
...
const TEST_C_RESUME = { summary: 'React Developer', projects: [{name: 'A', technologies: ['React', 'TypeScript'], included: true}, {name: 'B', technologies: ['Photoshop'], included: true}] } as any;
console.log("TEST C - Unrelated Projects:", calculateJobMatch(TEST_C_RESUME, TEST_C_JD).details.experienceScore > 0 ? 'PASS' : 'FAIL');

const TEST_D_RESUME = { summary: 'React Developer', projects: [{name: 'A', technologies: ['React', 'TypeScript'], included: false}] } as any;
...
const TEST_E_RESUME = { summary: "Frontend Developer", skills: ['React', 'TypeScript'] } as any;
...
const TEST_F_RESUME = { summary: "Frontend developer building React applications." } as any;
...
const TEST_G_RESUME = { summary: "Good program core" } as any;
...
const TEST_H_RESUME = { summary: "quantumcomputingframework " + "a ".repeat(500) } as any;
